...
@javax.annotation.Generated(value="de.elbosso.util.processors.GeneratorRestHandlerProcessor", date="2020-12-05T13:57:12.510Z")
public class QRCodeSVGSequenceHandler extends
java.lang.Object implements io.javalin.http.Handler
{
	private final de.elbosso.util.generator.generalpurpose.QRCodeSVGSequence generator=new de.elbosso.util.generator.generalpurpose.QRCodeSVGSequence();

	public static void register(io.javalin.Javalin app)
	{
		QRCodeSVGSequenceHandler handler=new QRCodeSVGSequenceHandler();
		app.get("/qrCodeSvg/", handler);
	}

	public QRCodeSVGSequenceHandler()
	{
		super();
	}
