...
@javax.annotation.Generated(value="de.elbosso.util.processors.GeneratorRestHandlerProcessor", date="2021-01-29T15:07:39.400Z")
public class RandomLanguageCodeSequenceHandler extends
java.lang.Object implements io.javalin.http.Handler
{
	...
	{
		RandomLanguageCodeSequenceHandler handler=new RandomLanguageCodeSequenceHandler();
		app.get("/languageCode/", handler);
	}

	public RandomLanguageCodeSequenceHandler()
	{
		super();
	}
	...
	@Override
	@OpenApi(
			summary = "Get RandomLanguageCodeSequence",
			deprecated = false,
			//tags = {"user"},
			responses = {
